...
namespace VLO.Controllers
{
    public class PedidosController : Controller
    {
        ...
        {
            var pedido = db.Pedido.Include(p => p.Empleado).Include(p => p.Mesa);
        ...
        public ActionResult Create([Bind(Include = "IdPedido,Cantidad,Cliente,IdMesa,IdEmpleado")] Pedido pedido)
        {
            ...
            ViewBag.IdEmpleado = new SelectList(db.Empleado, "IdEmpleado", "Nombre", pedido.IdEmpleado);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IdPedido,Cantidad,Cliente,IdMesa,IdEmpleado")] Pedido pedido)
        {
            if (ModelState.IsValid)
            {
